...
\end{abstract}
\keywords{structural reliability analysis, risk assessment, Bayesian networks, enhanced Bayesian networks, imprecise probability, concrete barriers degradation, chemical corrosion, climate change}
