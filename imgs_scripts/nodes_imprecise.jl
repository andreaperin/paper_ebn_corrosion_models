...
temperature_2020_df = DataFrame(
    :proj => [:ssp1, :ssp2, :ssp5],
    :Π => int_T_2020)
temperature_2020_node = ContinuousNode(:T_2020, ContinuousConditionalProbabilityTable{Tuple{Real,Real}}(temperature_2020_df))

temperature_2030_df = DataFrame(
    :proj => [:ssp1, :ssp2, :ssp5],
    :Π => int_T_2030)
temperature_2030_node = ContinuousNode(:T_2030, ContinuousConditionalProbabilityTable{Tuple{Real,Real}}(temperature_2030_df))

temperature_2040_df = DataFrame(
    :proj => [:ssp1, :ssp2, :ssp5],
    :Π => int_T_2040)
temperature_2040_node = ContinuousNode(:T_2040, ContinuousConditionalProbabilityTable{Tuple{Real,Real}}(temperature_2040_df))

temperature_2050_df = DataFrame(
    :proj => [:ssp1, :ssp2, :ssp5],
    :Π => int_T_2050)
temperature_2050_node = ContinuousNode(:T_2050, ContinuousConditionalProbabilityTable{Tuple{Real,Real}}(temperature_2050_df))

temperature_2060_df = DataFrame(
    :proj => [:ssp1, :ssp2, :ssp5],
    :Π => int_T_2060)
temperature_2060_node = ContinuousNode(:T_2060, ContinuousConditionalProbabilityTable{Tuple{Real,Real}}(temperature_2060_df))

temperature_2070_df = DataFrame(
    :proj => [:ssp1, :ssp2, :ssp5],
    :Π => int_T_2070)
temperature_2070_node = ContinuousNode(:T_2070, ContinuousConditionalProbabilityTable{Tuple{Real,Real}}(temperature_2070_df))

temperature_2080_df = DataFrame(
    :proj => [:ssp1, :ssp2, :ssp5],
    :Π => int_T_2080)
temperature_2080_node = ContinuousNode(:T_2080, ContinuousConditionalProbabilityTable{Tuple{Real,Real}}(temperature_2080_df))

temperature_2090_df = DataFrame(
    :proj => [:ssp1, :ssp2, :ssp5],
    :Π => int_T_2090)
temperature_2090_node = ContinuousNode(:T_2090, ContinuousConditionalProbabilityTable{Tuple{Real,Real}}(temperature_2090_df))

temperature_2100_df = DataFrame(
    :proj => [:ssp1, :ssp2, :ssp5],
    :Π => int_T_2100)
temperature_2100_node = ContinuousNode(:T_2100, ContinuousConditionalProbabilityTable{Tuple{Real,Real}}(temperature_2100_df))
