...
plt = @pgf Axis(
    {
        ...
        # xlabel = L"Year",
        ylabel = L"P_f",
        title = L"chloride \ induced \ corrosion \ P_f \  @ \ DeH \ \& \ DeCh\ - \ broken",
        width = "12cm",
        height = "8cm",
        grid = "major",
        ymin = -0.02,
...
plt = @pgf Axis(
    {
        ...
        # xlabel = L"Year",
        ylabel = L"P_f",
        title = L"chloride \ induced \ corrosion \ P_f \  @ \ DeH  - \ working \ ; \ DeCh \ - \ broken",
        width = "12cm",
        height = "8cm",
        grid = "major",
        ymin = -0.02,
...
plt = @pgf Axis(
    {
        ...
        # xlabel = L"Year",
        ylabel = L"P_f",
        title = L"carbonation \ induced \ corrosion \ P_f \  @ \ DeH \ - \ broken",
        width = "12cm",
        height = "8cm",
        grid = "major",
        ymin = -0.02,
